...
public final class Branch_20_ChunkLight implements BranchChunkLight {
    ...
    public Branch_20_ChunkLight(World world) {
        this(((CraftWorld) world).getHandle());
    }

    public Branch_20_ChunkLight(ServerLevel worldServer) {
        this(worldServer, new byte[worldServer.getSectionsCount() + 2][], new byte[worldServer.getSectionsCount() + 2][]);
    }

    public Branch_20_ChunkLight(ServerLevel worldServer, byte[][] blockLights, byte[][] skyLights) {
