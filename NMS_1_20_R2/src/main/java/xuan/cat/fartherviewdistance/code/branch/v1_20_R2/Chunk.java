...
public final class Chunk implements BranchChunk {
    ...
    public org.bukkit.block.Biome getBiome(int x, int y, int z) {
        return biomeBaseToBiome(levelChunk.biomeRegistry, levelChunk.getNoiseBiome(x, y, z));
    }
    ...
    public void setBiome(int x, int y, int z, org.bukkit.block.Biome biome) {
        levelChunk.setBiome(x, y, z, biomeToBiomeBase(levelChunk.biomeRegistry, biome));
    }
    ...
    private static final Map<org.bukkit.block.Biome, ResourceKey<net.minecraft.world.level.biome.Biome>> BIOME_KEY_CACHE = Collections.synchronizedMap(new EnumMap(org.bukkit.block.Biome.class));

    public static org.bukkit.block.Biome biomeBaseToBiome(Registry<net.minecraft.world.level.biome.Biome> registry, Holder<net.minecraft.world.level.biome.Biome> base) {
        return biomeBaseToBiome(registry, (net.minecraft.world.level.biome.Biome)base.value());
    }

    public static org.bukkit.block.Biome biomeBaseToBiome(Registry<net.minecraft.world.level.biome.Biome> registry, net.minecraft.world.level.biome.Biome base) {
        if (base == null) return null;
        org.bukkit.block.Biome biome = (org.bukkit.block.Biome) org.bukkit.Registry.BIOME.get(CraftNamespacedKey.fromMinecraft(registry.getKey(base)));
        return biome == null ? org.bukkit.block.Biome.CUSTOM : biome;
    }

    public static Holder<Biome> biomeToBiomeBase(Registry<Biome> registry, org.bukkit.block.Biome bio) {
        return bio != null && bio != org.bukkit.block.Biome.CUSTOM ? registry.getHolderOrThrow((ResourceKey) BIOME_KEY_CACHE.computeIfAbsent(bio, (b) -> ResourceKey.create(Registries.BIOME, CraftNamespacedKey.toMinecraft(b.getKey())))) : null;
    }
}
