...
public final class Branch_17_ChunkLight implements BranchChunkLight {
    ...
    public Branch_17_ChunkLight(World world) {
        this(((CraftWorld) world).getHandle());
    }

    public Branch_17_ChunkLight(WorldServer worldServer) {
        this(worldServer, new byte[worldServer.getSectionsCount() + 2][], new byte[worldServer.getSectionsCount() + 2][]);
    }

    public Branch_17_ChunkLight(WorldServer worldServer, byte[][] blockLights, byte[][] skyLights) {
