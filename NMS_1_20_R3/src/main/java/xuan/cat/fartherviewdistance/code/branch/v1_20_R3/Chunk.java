package xuan.cat.fartherviewdistance.code.branch.v1_20_R3;
...
public final class Chunk implements BranchChunk {
    ...
    private static final Map<org.bukkit.block.Biome, ResourceKey<Biome>> BIOME_KEY_CACHE = Collections.synchronizedMap(new EnumMap(org.bukkit.block.Biome.class));

    public static org.bukkit.block.Biome biomeBaseToBiome(Registry<Biome> registry, Holder<Biome> base) {
