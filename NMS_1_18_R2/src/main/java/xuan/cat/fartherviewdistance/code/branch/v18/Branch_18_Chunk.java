...
public final class Branch_18_Chunk implements BranchChunk {
    ...
    public Branch_18_Chunk(ServerLevel worldServer, ChunkAccess chunkAccess) {
    ...
    public BranchNBT toNBT(BranchChunkLight light, List<Runnable> asyncRunnable) {
        return new Branch_18_NBT(Branch_18_ChunkRegionLoader.saveChunk(worldServer, chunkAccess, (Branch_18_ChunkLight) light, asyncRunnable));
    }
